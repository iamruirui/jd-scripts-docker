...
(
  ...
  git clone https://github.com/iamruirui/jd-scripts-docker.git /jd-scripts-docker_tmp
...
(
  ...
  git clone --branch=master https://github.com/iamruirui/jd_scripts.git /scripts_tmp
  [ -d /scripts_tmp ] && {
    rm -rf /scripts
